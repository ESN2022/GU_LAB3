...
module lab3_sys_mm_interconnect_0 (
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> opencores_i2c_0_avalon_slave_0_agent:cp_channel
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> SWITCH_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // SWITCH_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> SWITCH_s1_agent:cp_channel
	...
	wire  [17:0] seg_s1_agent_m0_address;                                                            // SEG_s1_agent:m0_address -> SEG_s1_translator:uav_address
	...
	wire  [94:0] seg_s1_agent_rf_source_data;                                                        // SEG_s1_agent:rf_source_data -> SEG_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] seg_s1_agent_rsp_fifo_out_data;                                                     // SEG_s1_agent_rsp_fifo:out_data -> SEG_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> SEG_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> SEG_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // SEG_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SEG_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> SEG_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> SEG_s1_agent:cp_endofpacket
	...
	wire  [93:0] switch_s1_agent_rp_data;                                                            // SWITCH_s1_agent:rp_data -> router_006:sink_data
	...
	wire         seg_s1_agent_rp_valid;                                                              // SEG_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] seg_s1_agent_rp_data;                                                               // SEG_s1_agent:rp_data -> router_007:sink_data
	wire         seg_s1_agent_rp_ready;                                                              // router_007:sink_ready -> SEG_s1_agent:rp_ready
	wire         seg_s1_agent_rp_startofpacket;                                                      // SEG_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         seg_s1_agent_rp_endofpacket;                                                        // SEG_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         seg_s1_agent_rdata_fifo_src_valid;                                                  // SEG_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] seg_s1_agent_rdata_fifo_src_data;                                                   // SEG_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         seg_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_005:in_0_ready -> SEG_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> SEG_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> SEG_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // SEG_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> SEG_s1_agent:rdata_fifo_sink_error
	...
	lab3_sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (seg_s1_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (seg_s1_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (seg_s1_agent_rdata_fifo_src_ready),              //         .ready

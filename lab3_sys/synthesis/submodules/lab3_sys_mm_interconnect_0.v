...
module lab3_sys_mm_interconnect_0 (
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> SEG2_s1_agent:cp_valid
	wire  [95:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> SEG2_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // SEG2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [11:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> SEG2_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> SEG2_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> SEG2_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> SEG3_s1_agent:cp_valid
	wire  [95:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> SEG3_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // SEG3_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [11:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> SEG3_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> SEG3_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> SEG3_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> SEG4_s1_agent:cp_valid
	wire  [95:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> SEG4_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                              // SEG4_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> SEG4_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> SEG4_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> SEG4_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> SEG5_s1_agent:cp_valid
	wire  [95:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> SEG5_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                              // SEG5_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [11:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> SEG5_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                                      // cmd_mux_010:src_startofpacket -> SEG5_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                                        // cmd_mux_010:src_endofpacket -> SEG5_s1_agent:cp_endofpacket
	...
	wire  [95:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [95:0] seg2_s1_agent_rp_data;                                                              // SEG2_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [95:0] seg3_s1_agent_rp_data;                                                              // SEG3_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [95:0] seg4_s1_agent_rp_data;                                                              // SEG4_s1_agent:rp_data -> router_011:sink_data
	...
	wire         seg5_s1_agent_rp_valid;                                                             // SEG5_s1_agent:rp_valid -> router_012:sink_valid
	wire  [95:0] seg5_s1_agent_rp_data;                                                              // SEG5_s1_agent:rp_data -> router_012:sink_data
	wire         seg5_s1_agent_rp_ready;                                                             // router_012:sink_ready -> SEG5_s1_agent:rp_ready
	wire         seg5_s1_agent_rp_startofpacket;                                                     // SEG5_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire         seg5_s1_agent_rp_endofpacket;                                                       // SEG5_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire  [95:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_013:sink_data
	...
	wire         seg2_s1_agent_rdata_fifo_src_valid;                                                 // SEG2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] seg2_s1_agent_rdata_fifo_src_data;                                                  // SEG2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         seg2_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> SEG2_s1_agent:rdata_fifo_src_ready
	...
	wire         seg3_s1_agent_rdata_fifo_src_valid;                                                 // SEG3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] seg3_s1_agent_rdata_fifo_src_data;                                                  // SEG3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         seg3_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_008:in_0_ready -> SEG3_s1_agent:rdata_fifo_src_ready
	...
	wire         seg4_s1_agent_rdata_fifo_src_valid;                                                 // SEG4_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] seg4_s1_agent_rdata_fifo_src_data;                                                  // SEG4_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         seg4_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_009:in_0_ready -> SEG4_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> SEG4_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> SEG4_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                                  // SEG4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> SEG4_s1_agent:rdata_fifo_sink_error
	wire         seg5_s1_agent_rdata_fifo_src_valid;                                                 // SEG5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] seg5_s1_agent_rdata_fifo_src_data;                                                  // SEG5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         seg5_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_010:in_0_ready -> SEG5_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_010_out_0_valid;                                                  // avalon_st_adapter_010:out_0_valid -> SEG5_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                                   // avalon_st_adapter_010:out_0_data -> SEG5_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                                  // SEG5_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                                  // avalon_st_adapter_010:out_0_error -> SEG5_s1_agent:rdata_fifo_sink_error
